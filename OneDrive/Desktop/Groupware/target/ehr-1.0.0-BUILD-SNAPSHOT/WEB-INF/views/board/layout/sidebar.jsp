...
<head>
    ...
    .sidebar {
        ...
        background: linear-gradient(to bottom, var(--blue100), var(--blue200), var(--blue300));
...
<body>
    <div class="container">
        <nav class="sidebar">
            <h2>메뉴</h2>
            <ul>
                <li><a href="/board/announcement.do" class="container-fluid">게시판</a></li>
...
<%--                <li><a href="/board/marketing.do" class="container-fluid">마케팅 부서 게시판</a></li>--%>
                <li><a href="/callendar/show.do" class="container-fluid">캘린더</a></li>
            </ul>
        </nav>
</body>
</html>
